<?php /* Smarty version Smarty-3.1.19, created on 2021-02-11 17:42:32
         compiled from "/homepages/27/d707877555/htdocs/themes/MegaShop/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:144295202860255e78d7d185-98063149%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0bb15b64838b5a2c28f15b874d742a9408ec9eb1' => 
    array (
      0 => '/homepages/27/d707877555/htdocs/themes/MegaShop/header.tpl',
      1 => 1510743744,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '144295202860255e78d7d185-98063149',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60255e78db4cc1_60934453',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60255e78db4cc1_60934453')) {function content_60255e78db4cc1_60934453($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/homepages/27/d707877555/htdocs/tools/smarty/plugins/function.implode.php';
?>
<!DOCTYPE HTML>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
				...
				<div id="nav-row">
					<div class="container"><?php echo Smarty::$_smarty_vars['capture']['displayNav'];?>
</div>
				</div>
				<?php }?>
				<div id="header-row">
...
<?php }?>
						<div id="top-categ" class="hidden-md hidden-sm hidden-xs">
							<span><?php echo smartyTranslate(array('s'=>'Categories'),$_smarty_tpl);?>
</span>
						</div>
					</div>
				</div>
			...
			<div id="columns" class="clearfix">
				...
				<div id="left_column" class="column col-xs-12 col-lg-3"><?php echo $_smarty_tpl->tpl_vars['HOOK_LEFT_COLUMN']->value;?>
</div>
				<?php }?>
