<?php /* Smarty version Smarty-3.1.19, created on 2021-02-11 16:29:08
         compiled from "/homepages/27/d707877555/htdocs/themes/MegaShop/shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:38888369260254d446bf351-72018796%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7085f76d0b35fd1551679ff45c0a55195b7a65cf' => 
    array (
      0 => '/homepages/27/d707877555/htdocs/themes/MegaShop/shopping-cart.tpl',
      1 => 1510743744,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '38888369260254d446bf351-72018796',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60254d447baeb2_40031446',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60254d447baeb2_40031446')) {function content_60254d447baeb2_40031446($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/homepages/27/d707877555/htdocs/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
">
	...
	<?php if (!isset($_smarty_tpl->tpl_vars['empty']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
		<span class="heading-counter" style="margin:0 0 15px; display:block;"><?php echo smartyTranslate(array('s'=>'Your shopping cart contains:'),$_smarty_tpl);?>
...
<?php }?></span>
	...
	<div id="order-detail-content" class="clearfix">
		<table id="cart_summary" class="table <?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value) {?>stock-management-on<?php } else { ?>stock-management-off<?php }?>">
			<thead class="wide-screen">
				<tr>
					<th class="cart_delete first_item">&nbsp;</th>
					<th class="cart_product"><?php echo smartyTranslate(array('s'=>'Product'),$_smarty_tpl);?>
</th>
					...
					<?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value) {?>
						<th class="cart_avail item"><?php echo smartyTranslate(array('s'=>'Availability'),$_smarty_tpl);?>
</th>
					<?php }?>
...
<?php }?></span>
		...
		<table id="cart_summary_total" class="table">
			<tbody>
...
<?php }?></td>
				...
				<?php if ($_smarty_tpl->tpl_vars['use_taxes']->value&&$_smarty_tpl->tpl_vars['show_taxes']->value&&$_smarty_tpl->tpl_vars['total_tax']->value!=0) {?>
					<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value!=0) {?>
					<tr class="cart_total_price">
						<td><?php if ($_smarty_tpl->tpl_vars['display_tax_label']->value) {?><?php echo smartyTranslate(array('s'=>'Total (tax excl.)'),$_smarty_tpl);?>
...
<?php }?></td>
					...
					<tr class="cart_total_tax">
						<td><?php echo smartyTranslate(array('s'=>'Tax'),$_smarty_tpl);?>
</td>
...
<?php }?>" />
						...
						<button type="submit" name="submitAddDiscount" class="button"><?php echo smartyTranslate(array('s'=>'OK'),$_smarty_tpl);?>
</button>
					</div>
				</fieldset>
			</form>
		...
		<div class="order_delivery clearfix row">
			<?php if (!isset($_smarty_tpl->tpl_vars['formattedAddresses']->value)||(count($_smarty_tpl->tpl_vars['formattedAddresses']->value['invoice'])==0&&count($_smarty_tpl->tpl_vars['formattedAddresses']->value['delivery'])==0)||(count($_smarty_tpl->tpl_vars['formattedAddresses']->value['invoice']['formated'])==0&&count($_smarty_tpl->tpl_vars['formattedAddresses']->value['delivery']['formated'])==0)) {?>
				<?php if ($_smarty_tpl->tpl_vars['delivery']->value->id) {?>
					<div class="col-xs-12 col-md-6"<?php if (!$_smarty_tpl->tpl_vars['have_non_virtual_products']->value) {?> style="display: none;"<?php }?>>
...
?>
					<div class="col-xs-12 col-md-6"<?php if ($_smarty_tpl->tpl_vars['k']->value=='delivery'&&!$_smarty_tpl->tpl_vars['have_non_virtual_products']->value) {?> style="display: none;"<?php }?>>
...
<?php }?>" class="std-btn" title="<?php echo smartyTranslate(array('s'=>'Continue shopping'),$_smarty_tpl);?>
">
			<i class="fa fa-chevron-left left"></i><?php echo smartyTranslate(array('s'=>'Continue shopping'),$_smarty_tpl);?>
...
<?php }?>" class="button standard-checkout" title="<?php echo smartyTranslate(array('s'=>'Proceed to checkout'),$_smarty_tpl);?>
">
...
<i class="fa fa-chevron-right right"></i>
	...
	<?php if (isset($_smarty_tpl->tpl_vars['HOOK_SHOPPING_CART_EXTRA']->value)) {?>
		<div class="clear"></div>
