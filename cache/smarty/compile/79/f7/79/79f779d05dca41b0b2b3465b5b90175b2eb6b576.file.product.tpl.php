<?php /* Smarty version Smarty-3.1.19, created on 2021-02-11 17:39:04
         compiled from "/homepages/27/d707877555/htdocs/themes/MegaShop/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:139507018460255da8e021a8-25258942%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '79f779d05dca41b0b2b3465b5b90175b2eb6b576' => 
    array (
      0 => '/homepages/27/d707877555/htdocs/themes/MegaShop/product.tpl',
      1 => 1510743744,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '139507018460255da8e021a8-25258942',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60255da90403e2_34799707',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60255da90403e2_34799707')) {function content_60255da90403e2_34799707($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/homepages/27/d707877555/htdocs/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/homepages/27/d707877555/htdocs/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/homepages/27/d707877555/htdocs/tools/smarty/plugins/function.counter.php';
?>
...
">
	<div class="primary_block row">
		<?php if (isset($_smarty_tpl->tpl_vars['adminActionDisplay']->value)&&$_smarty_tpl->tpl_vars['adminActionDisplay']->value) {?>
			<div id="admin-action" class="col-xs-12">
...
" />
					<a id="publish_button" class="btn btn-default button button-small" href="#">
						<?php echo smartyTranslate(array('s'=>'Publish'),$_smarty_tpl);?>
		...
		<?php if (isset($_smarty_tpl->tpl_vars['confirmation']->value)&&$_smarty_tpl->tpl_vars['confirmation']->value) {?>
			<p class="confirmation col-xs-12">
		...
		<div class="pb-left-column col-md-6">
			...
			<div id="image-block" class="clearfix">
				<?php if ($_smarty_tpl->tpl_vars['product']->value->new) {?><span class="new-box"><?php echo smartyTranslate(array('s'=>'New'),$_smarty_tpl);?>
</span><?php }?>
				<?php if ($_smarty_tpl->tpl_vars['product']->value->on_sale||($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']&&$_smarty_tpl->tpl_vars['productPriceWithoutReduction']->value>$_smarty_tpl->tpl_vars['productPrice']->value)) {?><span class="sale-box"><?php echo smartyTranslate(array('s'=>'Sale!'),$_smarty_tpl);?>
</span><?php }?>				
...
" data-id="resetImages">
		...
		<div class="pb-right-column col-md-6">
			<h1 class="page-heading" itemprop="name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</h1>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['packItem']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
			...
			<?php if ($_smarty_tpl->tpl_vars['product']->value->manufacturer_name&&!$_smarty_tpl->tpl_vars['content_only']->value) {?>
			<p id="product_manufacturer">
				<label class="attribute_label"><?php echo smartyTranslate(array('s'=>'Brands'),$_smarty_tpl);?>
 :</label>
...
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->manufacturer_name, ENT_QUOTES, 'UTF-8', true);?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->manufacturer_name, ENT_QUOTES, 'UTF-8', true);?>
</a>
			</p>
			<?php }?>
			<p id="product_reference"<?php if (empty($_smarty_tpl->tpl_vars['product']->value->reference)||!$_smarty_tpl->tpl_vars['product']->value->reference) {?> style="display: none;"<?php }?>>
				<label class="attribute_label"><?php echo smartyTranslate(array('s'=>'Reference:'),$_smarty_tpl);?>
</label>
...
<?php }?></span>
			...
			<p id="product_condition">
				<label class="attribute_label"><?php echo smartyTranslate(array('s'=>'Condition'),$_smarty_tpl);?>
 :</label>
			...
			<p id="availability_statut"<?php if (!$_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value||($_smarty_tpl->tpl_vars['product']->value->quantity<=0&&!$_smarty_tpl->tpl_vars['product']->value->available_later&&$_smarty_tpl->tpl_vars['allow_oosp']->value)||($_smarty_tpl->tpl_vars['product']->value->quantity>0&&!$_smarty_tpl->tpl_vars['product']->value->available_now)||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> style="display: none;"<?php }?>>
				<label id="availability_label" class="attribute_label"><?php echo smartyTranslate(array('s'=>'Availability:'),$_smarty_tpl);?>
</label>
...
" id="product_page_product_id" />
 ...
 <b id="minimal_quantity_label"><?php echo $_smarty_tpl->tpl_vars['product']->value->minimal_quantity;?>
					...
					<p id="quantity_wanted_p"<?php if ((!$_smarty_tpl->tpl_vars['allow_oosp']->value&&$_smarty_tpl->tpl_vars['product']->value->quantity<=0)||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> style="display: none;"<?php }?>>
						<label for="quantity_wanted" class="attribute_label"><?php echo smartyTranslate(array('s'=>'Quantity'),$_smarty_tpl);?>
 :</label>
...
<?php }?>
						...
						<?php if (!$_smarty_tpl->tpl_vars['content_only']->value) {?><?php if (isset($_smarty_tpl->tpl_vars['HOOK_PRODUCT_ACTIONS']->value)&&$_smarty_tpl->tpl_vars['HOOK_PRODUCT_ACTIONS']->value) {?><?php echo $_smarty_tpl->tpl_vars['HOOK_PRODUCT_ACTIONS']->value;?>
<?php }?><?php }?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['attachment']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
							...
							<a class="button" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('attachment',true,null,"id_attachment=".((string)$_smarty_tpl->tpl_vars['attachment']->value['id_attachment'])), ENT_QUOTES, 'UTF-8', true);?>
">
...
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['name'], ENT_QUOTES, 'UTF-8', true),26,'...');?>
</a>
									</p>
