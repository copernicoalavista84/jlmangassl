<?php /* Smarty version Smarty-3.1.19, created on 2021-02-11 17:26:49
         compiled from "/homepages/27/d707877555/htdocs/themes/MegaShop/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:93127235060255ac9a3a683-80074894%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f132bc181866f585b01aef91b3b6040022b186c9' => 
    array (
      0 => '/homepages/27/d707877555/htdocs/themes/MegaShop/authentication.tpl',
      1 => 1510743744,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '93127235060255ac9a3a683-80074894',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60255ac9bf0059_56120901',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60255ac9bf0059_56120901')) {function content_60255ac9bf0059_56120901($_smarty_tpl) {?>
...
" method="post" id="create-account_form" class="box">
				<h3 class="subheading"><?php echo smartyTranslate(array('s'=>'Create an account'),$_smarty_tpl);?>
</h3>
...
" method="post" id="login_form" class="box">
				<h3 class="subheading"><?php echo smartyTranslate(array('s'=>'Already registered?'),$_smarty_tpl);?>
</h3>
				<div class="form_content clearfix">
					<div class="form-group">
...
" rel="nofollow"><?php echo smartyTranslate(array('s'=>'Forgot your password?'),$_smarty_tpl);?>
					...
					<p class="submit">
						<?php if (isset($_smarty_tpl->tpl_vars['back']->value)) {?><input type="hidden" class="hidden" name="back" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['back']->value, ENT_QUOTES, 'UTF-8', true);?>
" /><?php }?>
						<button type="submit" id="SubmitLogin" name="SubmitLogin" class="button button-medium">
...
" method="post" id="new_account_form" class="box">
			
				<div id="opc_account_form" style="display: block; ">
					<h3 class="subheading bottom-indent"><?php echo smartyTranslate(array('s'=>'Instant checkout'),$_smarty_tpl);?>
</h3>
...
&nbsp;&nbsp;</option>
					...
					<?php }?>
					<h3 class="subheading bottom-indent top-indent"><?php echo smartyTranslate(array('s'=>'Delivery address'),$_smarty_tpl);?>
</h3>
...
" />
					...
					<div id="opc_invoice_address"  class="unvisible">
						...
						<?php $_smarty_tpl->tpl_vars['postCodeExist'] = new Smarty_variable(false, null, 0);?>
						<?php $_smarty_tpl->tpl_vars['dniExist'] = new Smarty_variable(false, null, 0);?>
						<h3 class="subheading top-indent"><?php echo smartyTranslate(array('s'=>'Invoice address'),$_smarty_tpl);?>
</h3>
						<?php  $_smarty_tpl->tpl_vars['field_name'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['field_name']->_loop = false;
...
" />
			...
			<p class="cart_navigation required submit clearfix">
				...
				<button type="submit" class="button pull-right" name="submitGuestAccount" id="submitGuestAccount">
...
" method="post" id="account-creation_form" class="std box">
		...
		<div class="account_creation">
			<h3 class="subheading"><?php echo smartyTranslate(array('s'=>'Your personal information'),$_smarty_tpl);?>
</h3>
			<p class="required"><sup>*</sup><?php echo smartyTranslate(array('s'=>'Required field'),$_smarty_tpl);?>
</p>
			<div class="form-group">
...
<?php }?>" />
		...
		<?php if (isset($_smarty_tpl->tpl_vars['PS_REGISTRATION_PROCESS_TYPE']->value)&&$_smarty_tpl->tpl_vars['PS_REGISTRATION_PROCESS_TYPE']->value) {?>
			<div class="account_creation">
				<h3 class="subheading top-indent"><?php echo smartyTranslate(array('s'=>'Your address'),$_smarty_tpl);?>
</h3>
				<?php  $_smarty_tpl->tpl_vars['field_name'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['field_name']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['dlv_all_fields']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['field_name']->key => $_smarty_tpl->tpl_vars['field_name']->value) {
...
<?php }?>" />
			...
			<div class="account_creation dni">
				<h3 class="subheading"><?php echo smartyTranslate(array('s'=>'Tax identification'),$_smarty_tpl);?>
</h3>
				<p class="required form-group">
					<label for="dni"><?php echo smartyTranslate(array('s'=>'Identification number'),$_smarty_tpl);?>
 <sup>*</sup></label>
...
<?php }?>" />
		...
		<div class="submit clearfix">
			...
			<?php if (isset($_smarty_tpl->tpl_vars['back']->value)) {?><input type="hidden" class="hidden" name="back" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['back']->value, ENT_QUOTES, 'UTF-8', true);?>
" /><?php }?>
			<button type="submit" name="submitAccount" id="submitAccount" class="button button-medium">
