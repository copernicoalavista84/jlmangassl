<?php /* Smarty version Smarty-3.1.19, created on 2021-02-11 17:42:32
         compiled from "/homepages/27/d707877555/htdocs/themes/MegaShop/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:108243361660255e78a86d25-58640014%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '839c648ba4d1814f6d8ad755da1db5cf3a1ef13f' => 
    array (
      0 => '/homepages/27/d707877555/htdocs/themes/MegaShop/modules/blockcart/blockcart.tpl',
      1 => 1510743744,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '108243361660255e78a86d25-58640014',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60255e78b3e399_47593408',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60255e78b3e399_47593408')) {function content_60255e78b3e399_47593408($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/homepages/27/d707877555/htdocs/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_counter')) include '/homepages/27/d707877555/htdocs/tools/smarty/plugins/function.counter.php';
?>
<!-- MODULE Block cart -->

	<div class="shopping_cart <?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>header_user_catalog<?php }?>">
...
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['cart']->value->getOrderTotal(true,$_smarty_tpl->tpl_vars['cart_flag']->value)),$_smarty_tpl);?>
						...
						<p class="cart-buttons">
							<a id="button_order_cart" class="button" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8', true);?>
...
"><i class="fa fa-times"></i></span>
				<span class="title">
					<i class="fa fa-check left"></i><?php echo smartyTranslate(array('s'=>'Product successfully added to your shopping cart','mod'=>'blockcart'),$_smarty_tpl);?>
...
:</strong>
				...
				<div class="button-container">	
					<span class="continue std-btn" title="<?php echo smartyTranslate(array('s'=>'Continue shopping','mod'=>'blockcart'),$_smarty_tpl);?>
">
						<i class="fa fa-chevron-left left"></i><?php echo smartyTranslate(array('s'=>'Continue shopping','mod'=>'blockcart'),$_smarty_tpl);?>
